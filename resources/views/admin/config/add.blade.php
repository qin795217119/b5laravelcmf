    ...
    <form class="form-horizontal m" id="form-dict-add">
        ...
        <div class="form-group mb0">
            ...
            <div class="col-sm-3 mb15">
                @render('iframe',['name'=>'select','extend'=>['name'=>'style','data'=>$stylelist,'value'=>0,'class'=>'form-control']])
            </div>
            <label class="col-sm-2 control-label">配置分组：</label>
            <div class="col-sm-3 mb15">
                @render('iframe',['name'=>'select','extend'=>['name'=>'groups','place'=>'不分组','class'=>'form-control']])
            </div>
        </div>
